...
# checked
def create_application(workitemtype, title, environment):
...
for app, group_data in app_grouped: 
    ...
    for (app, env), group_data in grouped:
        if app == app_title:
            ...
            # environment = env
            environment = env
            parent_id2 = create_application(app_workitemtype, env_title, environment)
